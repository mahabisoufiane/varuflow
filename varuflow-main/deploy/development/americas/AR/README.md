...
```env
# Backend (Railway project: varuflow-development-ar)
...
```env
# Frontend (Vercel project: varuflow-development-ar)
NEXT_PUBLIC_API_URL=https://api-ar-development.varuflow.app
