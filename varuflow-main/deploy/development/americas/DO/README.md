...
```env
# Backend (Railway project: varuflow-development-do)
...
```env
# Frontend (Vercel project: varuflow-development-do)
NEXT_PUBLIC_API_URL=https://api-do-development.varuflow.app
