...
```env
# Backend (Railway project: varuflow-development-ec)
...
```env
# Frontend (Vercel project: varuflow-development-ec)
NEXT_PUBLIC_API_URL=https://api-ec-development.varuflow.app
