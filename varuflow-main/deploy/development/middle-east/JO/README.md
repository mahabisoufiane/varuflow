...
```env
# Backend (Railway project: varuflow-development-jo)
...
```env
# Frontend (Vercel project: varuflow-development-jo)
NEXT_PUBLIC_API_URL=https://api-jo-development.varuflow.app
