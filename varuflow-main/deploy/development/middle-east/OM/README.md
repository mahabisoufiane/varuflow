...
```env
# Backend (Railway project: varuflow-development-om)
...
```env
# Frontend (Vercel project: varuflow-development-om)
NEXT_PUBLIC_API_URL=https://api-om-development.varuflow.app
