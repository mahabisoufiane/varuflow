...
```env
# Backend (Railway project: varuflow-development-il)
...
```env
# Frontend (Vercel project: varuflow-development-il)
NEXT_PUBLIC_API_URL=https://api-il-development.varuflow.app
