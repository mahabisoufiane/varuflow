...
```env
# Backend (Railway project: varuflow-development-gr)
...
```env
# Frontend (Vercel project: varuflow-development-gr)
NEXT_PUBLIC_API_URL=https://api-gr-development.varuflow.app
