...
```env
# Backend (Railway project: varuflow-development-cz)
...
```env
# Frontend (Vercel project: varuflow-development-cz)
NEXT_PUBLIC_API_URL=https://api-cz-development.varuflow.app
