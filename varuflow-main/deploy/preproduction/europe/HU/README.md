...
```env
# Backend (Railway project: varuflow-preproduction-hu)
...
```env
# Frontend (Vercel project: varuflow-preproduction-hu)
NEXT_PUBLIC_API_URL=https://api-hu-preproduction.varuflow.app
