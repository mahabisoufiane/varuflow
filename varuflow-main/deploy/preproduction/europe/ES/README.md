...
```env
# Backend (Railway project: varuflow-preproduction-es)
...
```env
# Frontend (Vercel project: varuflow-preproduction-es)
NEXT_PUBLIC_API_URL=https://api-es-preproduction.varuflow.app
