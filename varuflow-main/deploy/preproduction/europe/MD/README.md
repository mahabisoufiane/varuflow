...
```env
# Backend (Railway project: varuflow-preproduction-md)
...
```env
# Frontend (Vercel project: varuflow-preproduction-md)
NEXT_PUBLIC_API_URL=https://api-md-preproduction.varuflow.app
