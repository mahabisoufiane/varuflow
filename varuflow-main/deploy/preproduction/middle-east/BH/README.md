...
```env
# Backend (Railway project: varuflow-preproduction-bh)
...
```env
# Frontend (Vercel project: varuflow-preproduction-bh)
NEXT_PUBLIC_API_URL=https://api-bh-preproduction.varuflow.app
