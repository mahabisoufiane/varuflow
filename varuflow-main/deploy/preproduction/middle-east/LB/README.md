...
```env
# Backend (Railway project: varuflow-preproduction-lb)
...
```env
# Frontend (Vercel project: varuflow-preproduction-lb)
NEXT_PUBLIC_API_URL=https://api-lb-preproduction.varuflow.app
