...
```env
# Backend (Railway project: varuflow-preproduction-ye)
...
```env
# Frontend (Vercel project: varuflow-preproduction-ye)
NEXT_PUBLIC_API_URL=https://api-ye-preproduction.varuflow.app
