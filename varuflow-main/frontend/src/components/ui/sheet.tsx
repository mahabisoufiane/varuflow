...
// Purpose: shadcn/ui Sheet (slide-over panel) built on @radix-ui/react-dialog.
// Added for the operator console: ContentPanel detail view + mobile resource-tree
// drawer. Styling/animation conventions mirror the existing ui/dialog.tsx.
...
const SheetHeader = ({ className, ...props }: React.HTMLAttributes<HTMLDivElement>) => (
  <div className={cn("flex flex-col space-y-1.5 p-4 text-left", className)} {...props} />
);
