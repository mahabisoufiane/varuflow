...
function VerifyInner() {
  ...
  useEffect(() => {
    ...
    portalApi
      ...
      .then((res) => {
        // QuotaExceeded (Safari private mode, full storage) would otherwise
        // throw here and leave the user stuck on the verifying screen with
        // no usable token.
        try {
          ...
          setStatus("error");
          setError("Could not save your session. Please enable cookies / local storage and try again.");
          return;
        }
