...
from app.features.inventory.models import Product, StockLevel, StockMovement, StockMovementType, Warehouse
from .models import PosPaymentMethod, PosSession, PosSessionStatus, PosSale, PosSaleItem
...
async def create_sale(
    ...
    if body.customer_id is not None:
        from app.features.invoicing.models import Customer as _Customer
