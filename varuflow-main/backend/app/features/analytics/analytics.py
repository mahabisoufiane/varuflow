...
from app.features.inventory.models import Product, PurchaseOrder, PurchaseOrderStatus, StockLevel, StockMovement, Warehouse
from app.features.invoicing.models import Customer, Invoice, InvoiceLineItem, InvoiceStatus, Payment
...
async def _expense_summary(
    ...
    try:
        ...
        from app.features.expenses.models import Expense as _E, ExpenseStatus as _ES
