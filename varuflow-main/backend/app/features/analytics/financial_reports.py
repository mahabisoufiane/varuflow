...
from .accounting_models import AccountType, ChartOfAccount, JournalEntry, JournalLine
from app.features.auth.organization import OrgPlan

router = APIRouter(prefix="/api/accounting/reports", tags=["financial_reports"], dependencies=[Depends(require_module("finance"))])
