...
from .accounting_models import JournalEntry, JournalLine
from .budget_models import Budget, BudgetLine
from app.features.auth.organization import OrgRole
from app.services.audit import log_action

# Budgets are manager-level planning data — gate at ADMIN.
router = APIRouter(prefix="/api/accounting/budgets", tags=["budget"], dependencies=[Depends(require_module("finance")), Depends(require_role(OrgRole.ADMIN))])
