...
from .membership_tier import CustomerMembership, MembershipTier
from app.middleware.plan_check import require_module

logger = logging.getLogger(__name__)
router = APIRouter(prefix="/api/membership-tiers", tags=["membership-tiers"], dependencies=[Depends(require_module("crm"))])
