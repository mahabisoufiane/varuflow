...
class InvoiceLineItem(Base):
    ...
    __table_args__ = (
        CheckConstraint("quantity > 0", name="ck_invoice_line_item_quantity_positive"),
        CheckConstraint("unit_price >= 0", name="ck_invoice_line_item_unit_price_non_negative"),
        CheckConstraint("tax_rate >= 0 AND tax_rate <= 100", name="ck_invoice_line_item_tax_rate_range"),
    )
...
class Payment(Base):
    ...
    __table_args__ = (
        ...
        CheckConstraint("exchange_rate > 0", name="ck_payment_exchange_rate_positive"),
    )
