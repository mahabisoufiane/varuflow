...
from app.features.invoicing.dispute import Dispute, DisputeMessage
from app.middleware.plan_check import require_module

logger = logging.getLogger(__name__)

router = APIRouter(prefix="/api/disputes", tags=["disputes"], dependencies=[Depends(require_module("invoicing"))])
