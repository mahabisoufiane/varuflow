...
from app.features.customers.staff_portfolio_photo import StaffPortfolioPhoto
from app.middleware.plan_check import require_module

logger = logging.getLogger(__name__)

router = APIRouter(prefix="/api/portfolio", tags=["portfolio"], dependencies=[Depends(require_module("crm"))])
