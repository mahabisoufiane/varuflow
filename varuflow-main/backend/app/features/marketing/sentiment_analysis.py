...
from app.features.notifications.sentiment_log import ConversationSentimentLog
from app.features.notifications.unified_message import UnifiedInboxThread, UnifiedMessage
from app.middleware.plan_check import require_module

logger = logging.getLogger(__name__)

router = APIRouter(prefix="/api/inbox/sentiment", tags=["sentiment-analysis"], dependencies=[Depends(require_module("ai"))])
