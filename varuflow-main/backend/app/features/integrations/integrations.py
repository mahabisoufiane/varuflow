...
from app.features.auth.organization import FortnoxOAuthState, OrgPlan, OrgRole, Organization
...
async def ai_chat(
    ...
    from app.features.invoicing.models import Invoice, InvoiceStatus, Payment
