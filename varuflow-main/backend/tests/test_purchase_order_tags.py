...
ROUTER_SRC    = _read("app/features/purchases/purchase_order_tags.py")
MIGRATION_SRC = _read(
    "migrations/versions/c6d8e0f2a4b9_v91_purchase_order_tags.py"
)
MODEL_SRC     = _read("app/features/purchases/purchase_order_tag.py")
...
def test_router_registered_in_main():
    ...
    assert "purchase_order_tags" in feat_src
