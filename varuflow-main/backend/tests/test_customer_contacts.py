...
ROUTER_SRC    = _read("app/features/customers/customer_contacts.py")
try:
    MIGRATION_SRC = _read("migrations/versions/d2e4f6a8b0c3_v80_customer_contacts.py")
except FileNotFoundError:
    MIGRATION_SRC = ""
MODEL_SRC     = _read("app/features/customers/customer_contact.py")
...
def test_router_registered_in_main():
    ...
    assert "customer_contacts" in feat_src
