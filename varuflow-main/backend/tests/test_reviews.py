...
ROUTER_SRC = _read("features/marketing/reviews.py")
SERVICE_SRC = _read("services/review_service.py")
DISPATCH_SRC = _read("services/review_dispatch.py")
MODEL_SRC = _read("features/marketing/reviews_models.py")
...
def test_router_registered_in_main():
    ...
    # reviews is registered via marketing_router; public_router via _reviews_public_router
    feat_src = _read("features/marketing/router.py")
    assert "reviews" in feat_src
    assert "marketing_router" in MAIN_SRC
    assert "_reviews_public_router" in MAIN_SRC
