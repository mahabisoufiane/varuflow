...
```env
# Backend (Railway project: varuflow-preproduction-uy)
...
```env
# Frontend (Vercel project: varuflow-preproduction-uy)
NEXT_PUBLIC_API_URL=https://api-uy-preproduction.varuflow.app
