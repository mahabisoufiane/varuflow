...
```env
# Backend (Railway project: varuflow-preproduction-gr)
...
```env
# Frontend (Vercel project: varuflow-preproduction-gr)
NEXT_PUBLIC_API_URL=https://api-gr-preproduction.varuflow.app
