...
```env
# Backend (Railway project: varuflow-preproduction-lu)
...
```env
# Frontend (Vercel project: varuflow-preproduction-lu)
NEXT_PUBLIC_API_URL=https://api-lu-preproduction.varuflow.app
