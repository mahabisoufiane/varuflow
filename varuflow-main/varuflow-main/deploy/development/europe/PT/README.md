...
```env
# Backend (Railway project: varuflow-development-pt)
...
```env
# Frontend (Vercel project: varuflow-development-pt)
NEXT_PUBLIC_API_URL=https://api-pt-development.varuflow.app
