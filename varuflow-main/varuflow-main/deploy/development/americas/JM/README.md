...
```env
# Backend (Railway project: varuflow-development-jm)
...
```env
# Frontend (Vercel project: varuflow-development-jm)
NEXT_PUBLIC_API_URL=https://api-jm-development.varuflow.app
