...
```env
# Backend (Railway project: varuflow-development-co)
...
```env
# Frontend (Vercel project: varuflow-development-co)
NEXT_PUBLIC_API_URL=https://api-co-development.varuflow.app
