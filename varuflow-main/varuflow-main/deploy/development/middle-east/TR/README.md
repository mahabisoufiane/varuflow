...
```env
# Backend (Railway project: varuflow-development-tr)
...
```env
# Frontend (Vercel project: varuflow-development-tr)
NEXT_PUBLIC_API_URL=https://api-tr-development.varuflow.app
