"""Supplier contacts (Item 78) — named contact persons per supplier."""
...
class SupplierContact(Base):
    ...
    # PII — same EncryptedString treatment as suppliers.email / phone.
    ...
    receives_rfq: Mapped[bool] = mapped_column(
    ...
    __table_args__ = (
        ...
        Index("ix_supplier_contacts_org_id", "org_id"),
    )
