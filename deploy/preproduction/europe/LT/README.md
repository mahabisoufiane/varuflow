...
```env
# Backend (Railway project: varuflow-preproduction-lt)
...
```env
# Frontend (Vercel project: varuflow-preproduction-lt)
NEXT_PUBLIC_API_URL=https://api-lt-preproduction.varuflow.app
