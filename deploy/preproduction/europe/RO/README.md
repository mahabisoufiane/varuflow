...
```env
# Backend (Railway project: varuflow-preproduction-ro)
...
```env
# Frontend (Vercel project: varuflow-preproduction-ro)
NEXT_PUBLIC_API_URL=https://api-ro-preproduction.varuflow.app
