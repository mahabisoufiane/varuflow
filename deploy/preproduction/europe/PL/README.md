...
```env
# Backend (Railway project: varuflow-preproduction-pl)
...
```env
# Frontend (Vercel project: varuflow-preproduction-pl)
NEXT_PUBLIC_API_URL=https://api-pl-preproduction.varuflow.app
