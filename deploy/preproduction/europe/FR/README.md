...
```env
# Backend (Railway project: varuflow-preproduction-fr)
...
```env
# Frontend (Vercel project: varuflow-preproduction-fr)
NEXT_PUBLIC_API_URL=https://api-fr-preproduction.varuflow.app
