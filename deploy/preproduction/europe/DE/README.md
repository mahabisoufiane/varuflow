...
```env
# Backend (Railway project: varuflow-preproduction-de)
...
```env
# Frontend (Vercel project: varuflow-preproduction-de)
NEXT_PUBLIC_API_URL=https://api-de-preproduction.varuflow.app
