...
```env
# Backend (Railway project: varuflow-preproduction-be)
...
```env
# Frontend (Vercel project: varuflow-preproduction-be)
NEXT_PUBLIC_API_URL=https://api-be-preproduction.varuflow.app
