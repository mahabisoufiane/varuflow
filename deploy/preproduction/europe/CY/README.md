...
```env
# Backend (Railway project: varuflow-preproduction-cy)
...
```env
# Frontend (Vercel project: varuflow-preproduction-cy)
NEXT_PUBLIC_API_URL=https://api-cy-preproduction.varuflow.app
