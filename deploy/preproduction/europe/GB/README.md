...
```env
# Backend (Railway project: varuflow-preproduction-gb)
...
```env
# Frontend (Vercel project: varuflow-preproduction-gb)
NEXT_PUBLIC_API_URL=https://api-gb-preproduction.varuflow.app
