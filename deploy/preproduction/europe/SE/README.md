...
```env
# Backend (Railway project: varuflow-preproduction-se)
...
```env
# Frontend (Vercel project: varuflow-preproduction-se)
NEXT_PUBLIC_API_URL=https://api-se-preproduction.varuflow.app
