...
```env
# Backend (Railway project: varuflow-preproduction-al)
...
```env
# Frontend (Vercel project: varuflow-preproduction-al)
NEXT_PUBLIC_API_URL=https://api-al-preproduction.varuflow.app
