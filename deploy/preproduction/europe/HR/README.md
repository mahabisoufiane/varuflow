...
```env
# Backend (Railway project: varuflow-preproduction-hr)
...
```env
# Frontend (Vercel project: varuflow-preproduction-hr)
NEXT_PUBLIC_API_URL=https://api-hr-preproduction.varuflow.app
