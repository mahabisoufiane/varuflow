...
```env
# Backend (Railway project: varuflow-preproduction-fi)
...
```env
# Frontend (Vercel project: varuflow-preproduction-fi)
NEXT_PUBLIC_API_URL=https://api-fi-preproduction.varuflow.app
