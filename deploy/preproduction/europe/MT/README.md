...
```env
# Backend (Railway project: varuflow-preproduction-mt)
...
```env
# Frontend (Vercel project: varuflow-preproduction-mt)
NEXT_PUBLIC_API_URL=https://api-mt-preproduction.varuflow.app
