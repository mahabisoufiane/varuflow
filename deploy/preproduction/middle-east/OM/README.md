...
```env
# Backend (Railway project: varuflow-preproduction-om)
...
```env
# Frontend (Vercel project: varuflow-preproduction-om)
NEXT_PUBLIC_API_URL=https://api-om-preproduction.varuflow.app
