...
```env
# Backend (Railway project: varuflow-preproduction-jo)
...
```env
# Frontend (Vercel project: varuflow-preproduction-jo)
NEXT_PUBLIC_API_URL=https://api-jo-preproduction.varuflow.app
