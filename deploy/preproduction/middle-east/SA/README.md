...
```env
# Backend (Railway project: varuflow-preproduction-sa)
...
```env
# Frontend (Vercel project: varuflow-preproduction-sa)
NEXT_PUBLIC_API_URL=https://api-sa-preproduction.varuflow.app
