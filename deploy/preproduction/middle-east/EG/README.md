...
```env
# Backend (Railway project: varuflow-preproduction-eg)
...
```env
# Frontend (Vercel project: varuflow-preproduction-eg)
NEXT_PUBLIC_API_URL=https://api-eg-preproduction.varuflow.app
