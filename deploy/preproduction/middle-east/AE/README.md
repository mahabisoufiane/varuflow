# United Arab Emirates — preproduction
...
```env
# Backend (Railway project: varuflow-preproduction-ae)
...
```env
# Frontend (Vercel project: varuflow-preproduction-ae)
NEXT_PUBLIC_API_URL=https://api-ae-preproduction.varuflow.app
