...
```env
# Backend (Railway project: varuflow-preproduction-tr)
...
```env
# Frontend (Vercel project: varuflow-preproduction-tr)
NEXT_PUBLIC_API_URL=https://api-tr-preproduction.varuflow.app
