...
```env
# Backend (Railway project: varuflow-preproduction-pa)
...
```env
# Frontend (Vercel project: varuflow-preproduction-pa)
NEXT_PUBLIC_API_URL=https://api-pa-preproduction.varuflow.app
