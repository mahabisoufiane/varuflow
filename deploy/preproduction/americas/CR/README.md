...
```env
# Backend (Railway project: varuflow-preproduction-cr)
...
```env
# Frontend (Vercel project: varuflow-preproduction-cr)
NEXT_PUBLIC_API_URL=https://api-cr-preproduction.varuflow.app
