...
```env
# Backend (Railway project: varuflow-preproduction-cl)
...
```env
# Frontend (Vercel project: varuflow-preproduction-cl)
NEXT_PUBLIC_API_URL=https://api-cl-preproduction.varuflow.app
