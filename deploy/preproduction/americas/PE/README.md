...
```env
# Backend (Railway project: varuflow-preproduction-pe)
...
```env
# Frontend (Vercel project: varuflow-preproduction-pe)
NEXT_PUBLIC_API_URL=https://api-pe-preproduction.varuflow.app
