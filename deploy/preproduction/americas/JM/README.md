...
```env
# Backend (Railway project: varuflow-preproduction-jm)
...
```env
# Frontend (Vercel project: varuflow-preproduction-jm)
NEXT_PUBLIC_API_URL=https://api-jm-preproduction.varuflow.app
