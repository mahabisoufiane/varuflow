...
```env
# Backend (Railway project: varuflow-preproduction-ec)
...
```env
# Frontend (Vercel project: varuflow-preproduction-ec)
NEXT_PUBLIC_API_URL=https://api-ec-preproduction.varuflow.app
