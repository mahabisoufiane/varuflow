...
```env
# Backend (Railway project: varuflow-preproduction-gt)
...
```env
# Frontend (Vercel project: varuflow-preproduction-gt)
NEXT_PUBLIC_API_URL=https://api-gt-preproduction.varuflow.app
