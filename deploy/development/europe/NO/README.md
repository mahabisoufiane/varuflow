...
```env
# Backend (Railway project: varuflow-development-no)
...
```env
# Frontend (Vercel project: varuflow-development-no)
NEXT_PUBLIC_API_URL=https://api-no-development.varuflow.app
