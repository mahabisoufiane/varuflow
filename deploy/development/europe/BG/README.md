...
```env
# Backend (Railway project: varuflow-development-bg)
...
```env
# Frontend (Vercel project: varuflow-development-bg)
NEXT_PUBLIC_API_URL=https://api-bg-development.varuflow.app
