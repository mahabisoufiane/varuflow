...
```env
# Backend (Railway project: varuflow-development-at)
...
```env
# Frontend (Vercel project: varuflow-development-at)
NEXT_PUBLIC_API_URL=https://api-at-development.varuflow.app
