...
```env
# Backend (Railway project: varuflow-development-rs)
...
```env
# Frontend (Vercel project: varuflow-development-rs)
NEXT_PUBLIC_API_URL=https://api-rs-development.varuflow.app
