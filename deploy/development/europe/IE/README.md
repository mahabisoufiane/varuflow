...
```env
# Backend (Railway project: varuflow-development-ie)
...
```env
# Frontend (Vercel project: varuflow-development-ie)
NEXT_PUBLIC_API_URL=https://api-ie-development.varuflow.app
