...
```env
# Backend (Railway project: varuflow-development-mk)
...
```env
# Frontend (Vercel project: varuflow-development-mk)
NEXT_PUBLIC_API_URL=https://api-mk-development.varuflow.app
