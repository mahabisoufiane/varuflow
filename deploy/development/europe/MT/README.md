...
```env
# Backend (Railway project: varuflow-development-mt)
...
```env
# Frontend (Vercel project: varuflow-development-mt)
NEXT_PUBLIC_API_URL=https://api-mt-development.varuflow.app
