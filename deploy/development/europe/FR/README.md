...
```env
# Backend (Railway project: varuflow-development-fr)
...
```env
# Frontend (Vercel project: varuflow-development-fr)
NEXT_PUBLIC_API_URL=https://api-fr-development.varuflow.app
