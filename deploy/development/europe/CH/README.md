...
```env
# Backend (Railway project: varuflow-development-ch)
...
```env
# Frontend (Vercel project: varuflow-development-ch)
NEXT_PUBLIC_API_URL=https://api-ch-development.varuflow.app
