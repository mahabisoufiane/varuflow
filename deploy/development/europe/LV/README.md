...
```env
# Backend (Railway project: varuflow-development-lv)
...
```env
# Frontend (Vercel project: varuflow-development-lv)
NEXT_PUBLIC_API_URL=https://api-lv-development.varuflow.app
