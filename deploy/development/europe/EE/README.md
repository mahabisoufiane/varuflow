...
```env
# Backend (Railway project: varuflow-development-ee)
...
```env
# Frontend (Vercel project: varuflow-development-ee)
NEXT_PUBLIC_API_URL=https://api-ee-development.varuflow.app
