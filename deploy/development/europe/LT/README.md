...
```env
# Backend (Railway project: varuflow-development-lt)
...
```env
# Frontend (Vercel project: varuflow-development-lt)
NEXT_PUBLIC_API_URL=https://api-lt-development.varuflow.app
