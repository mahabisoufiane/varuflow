...
```env
# Backend (Railway project: varuflow-development-me)
...
```env
# Frontend (Vercel project: varuflow-development-me)
NEXT_PUBLIC_API_URL=https://api-me-development.varuflow.app
