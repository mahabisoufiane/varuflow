...
```env
# Backend (Railway project: varuflow-development-be)
...
```env
# Frontend (Vercel project: varuflow-development-be)
NEXT_PUBLIC_API_URL=https://api-be-development.varuflow.app
