...
```env
# Backend (Railway project: varuflow-development-pl)
...
```env
# Frontend (Vercel project: varuflow-development-pl)
NEXT_PUBLIC_API_URL=https://api-pl-development.varuflow.app
