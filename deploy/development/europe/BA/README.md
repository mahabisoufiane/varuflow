...
```env
# Backend (Railway project: varuflow-development-ba)
...
```env
# Frontend (Vercel project: varuflow-development-ba)
NEXT_PUBLIC_API_URL=https://api-ba-development.varuflow.app
