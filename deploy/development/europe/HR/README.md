...
```env
# Backend (Railway project: varuflow-development-hr)
...
```env
# Frontend (Vercel project: varuflow-development-hr)
NEXT_PUBLIC_API_URL=https://api-hr-development.varuflow.app
