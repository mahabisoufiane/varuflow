...
```env
# Backend (Railway project: varuflow-development-dk)
...
```env
# Frontend (Vercel project: varuflow-development-dk)
NEXT_PUBLIC_API_URL=https://api-dk-development.varuflow.app
