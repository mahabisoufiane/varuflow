...
```env
# Backend (Railway project: varuflow-development-ua)
...
```env
# Frontend (Vercel project: varuflow-development-ua)
NEXT_PUBLIC_API_URL=https://api-ua-development.varuflow.app
