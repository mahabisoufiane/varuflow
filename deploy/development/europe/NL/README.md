...
```env
# Backend (Railway project: varuflow-development-nl)
...
```env
# Frontend (Vercel project: varuflow-development-nl)
NEXT_PUBLIC_API_URL=https://api-nl-development.varuflow.app
