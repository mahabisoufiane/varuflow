...
```env
# Backend (Railway project: varuflow-development-si)
...
```env
# Frontend (Vercel project: varuflow-development-si)
NEXT_PUBLIC_API_URL=https://api-si-development.varuflow.app
