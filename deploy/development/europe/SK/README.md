...
```env
# Backend (Railway project: varuflow-development-sk)
...
```env
# Frontend (Vercel project: varuflow-development-sk)
NEXT_PUBLIC_API_URL=https://api-sk-development.varuflow.app
