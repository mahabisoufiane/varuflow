...
```env
# Backend (Railway project: varuflow-development-it)
...
```env
# Frontend (Vercel project: varuflow-development-it)
NEXT_PUBLIC_API_URL=https://api-it-development.varuflow.app
