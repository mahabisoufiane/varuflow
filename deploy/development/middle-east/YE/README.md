...
```env
# Backend (Railway project: varuflow-development-ye)
...
```env
# Frontend (Vercel project: varuflow-development-ye)
NEXT_PUBLIC_API_URL=https://api-ye-development.varuflow.app
