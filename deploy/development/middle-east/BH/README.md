...
```env
# Backend (Railway project: varuflow-development-bh)
...
```env
# Frontend (Vercel project: varuflow-development-bh)
NEXT_PUBLIC_API_URL=https://api-bh-development.varuflow.app
