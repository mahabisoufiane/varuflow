...
```env
# Backend (Railway project: varuflow-development-lb)
...
```env
# Frontend (Vercel project: varuflow-development-lb)
NEXT_PUBLIC_API_URL=https://api-lb-development.varuflow.app
