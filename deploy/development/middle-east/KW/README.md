...
```env
# Backend (Railway project: varuflow-development-kw)
...
```env
# Frontend (Vercel project: varuflow-development-kw)
NEXT_PUBLIC_API_URL=https://api-kw-development.varuflow.app
