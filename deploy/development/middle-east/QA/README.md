...
```env
# Backend (Railway project: varuflow-development-qa)
...
```env
# Frontend (Vercel project: varuflow-development-qa)
NEXT_PUBLIC_API_URL=https://api-qa-development.varuflow.app
