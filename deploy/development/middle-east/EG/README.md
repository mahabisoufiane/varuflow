...
```env
# Backend (Railway project: varuflow-development-eg)
...
```env
# Frontend (Vercel project: varuflow-development-eg)
NEXT_PUBLIC_API_URL=https://api-eg-development.varuflow.app
