...
```env
# Backend (Railway project: varuflow-development-gt)
...
```env
# Frontend (Vercel project: varuflow-development-gt)
NEXT_PUBLIC_API_URL=https://api-gt-development.varuflow.app
