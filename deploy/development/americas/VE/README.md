...
```env
# Backend (Railway project: varuflow-development-ve)
...
```env
# Frontend (Vercel project: varuflow-development-ve)
NEXT_PUBLIC_API_URL=https://api-ve-development.varuflow.app
