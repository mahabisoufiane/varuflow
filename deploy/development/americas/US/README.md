...
```env
# Backend (Railway project: varuflow-development-us)
...
```env
# Frontend (Vercel project: varuflow-development-us)
NEXT_PUBLIC_API_URL=https://api-us-development.varuflow.app
