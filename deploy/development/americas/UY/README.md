...
```env
# Backend (Railway project: varuflow-development-uy)
...
```env
# Frontend (Vercel project: varuflow-development-uy)
NEXT_PUBLIC_API_URL=https://api-uy-development.varuflow.app
