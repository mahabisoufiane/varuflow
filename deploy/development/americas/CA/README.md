...
```env
# Backend (Railway project: varuflow-development-ca)
...
```env
# Frontend (Vercel project: varuflow-development-ca)
NEXT_PUBLIC_API_URL=https://api-ca-development.varuflow.app
