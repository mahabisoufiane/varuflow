...
```env
# Backend (Railway project: varuflow-development-py)
...
```env
# Frontend (Vercel project: varuflow-development-py)
NEXT_PUBLIC_API_URL=https://api-py-development.varuflow.app
