...
```env
# Backend (Railway project: varuflow-development-mx)
...
```env
# Frontend (Vercel project: varuflow-development-mx)
NEXT_PUBLIC_API_URL=https://api-mx-development.varuflow.app
