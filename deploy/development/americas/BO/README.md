...
```env
# Backend (Railway project: varuflow-development-bo)
...
```env
# Frontend (Vercel project: varuflow-development-bo)
NEXT_PUBLIC_API_URL=https://api-bo-development.varuflow.app
