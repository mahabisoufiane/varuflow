...
from app.models.hr import EmployeeEmergencyContact, EmployeeProfile
...
@router.get("/api/hr/employees/{staff_id}/profile")
...
@router.post("/api/hr/employees/{staff_id}/profile")
...
@router.get("/api/hr/employees/{staff_id}/contracts")
...
@router.post("/api/hr/employees/{staff_id}/contracts", status_code=201)
...
@router.patch("/api/hr/employees/{staff_id}/contracts/{contract_id}")
...
@router.delete("/api/hr/employees/{staff_id}/contracts/{contract_id}", status_code=204)
...
@router.get("/api/hr/employees/{staff_id}/emergency-contacts")
...
@router.post("/api/hr/employees/{staff_id}/emergency-contacts", status_code=201)
...
@router.patch("/api/hr/employees/{staff_id}/emergency-contacts/{contact_id}")
...
@router.delete("/api/hr/employees/{staff_id}/emergency-contacts/{contact_id}", status_code=204)
