...
async def _invoice_items(
    ...
    from app.models.invoicing import Invoice, Customer
...
async def _recurring_items(
    ...
    from app.models.invoicing import RecurringInvoice, Invoice as Inv
    rows = (await db.execute(
        select(
            RecurringInvoice.id,
...
async def _adjustment_items(
    ...
    from app.models.cashflow import CashFlowAdjustment
    rows = (await db.execute(
