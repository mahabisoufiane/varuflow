...
from app.models.service_insurance_addon import BookingInsurancePurchase, ServiceInsuranceAddon

logger = logging.getLogger(__name__)

router = APIRouter(prefix="/api/insurance", tags=["insurance-addons"])
