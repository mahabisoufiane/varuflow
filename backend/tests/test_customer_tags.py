...
ROUTER_SRC    = _read("app/routers/customer_tags.py")
MIGRATION_SRC = _read("migrations/versions/c1d3e5f7a9b2_v79_customer_tags.py")
MODEL_SRC     = _read("app/models/customer_tag.py")
...
def test_router_registered_in_main():
    assert "customer_tags.router" in MAIN_SRC
    assert "customer_tags," in MAIN_SRC
