  ...
  return (
    <>
      ...
      <section
        ...
        style={{
          background:
            "radial-gradient(ellipse 100% 70% at 50% -10%, rgba(74,108,247,0.18) 0%, transparent 65%)",
        }}
      >
        {/* Glow blob */}
        <div
      ...
      <section
        ...
        style={{
          background:
            "radial-gradient(ellipse 80% 50% at 50% 50%, rgba(74,108,247,0.06) 0%, transparent 70%)",
        }}
      >
