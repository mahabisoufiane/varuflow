...
const SIDEBAR_SECTIONS: SidebarSection[] = [
  {
    ...
    items: [
      ...
      { href: "/reports/dashboard",    icon: BarChart3,       key: "rptDashboard",    module: "analytics" },
  ...
  },
  {
    ...
    items: [
      ...
      { href: "/manufacturing",          icon: Factory,        key: "mfgOrders",     module: "inventory" },
      { href: "/manufacturing/bom",      icon: BookCopy,       key: "mfgBom",        module: "inventory" },
      { href: "/manufacturing/planning", icon: CalendarCheck2, key: "mfgPlanning",   module: "inventory" },
      { href: "/manufacturing/qc",       icon: ClipboardCheck, key: "mfgQc",         module: "inventory" },
      { href: "/kitting",                icon: Package,        key: "kitting",       module: "inventory" },
  ...
  },
  {
    ...
    items: [
      ...
      { href: "/ai/automation",                icon: TrendingUp,key: "aiAutomation",  module: "ai" },
      { href: "/ai/workflows",                 icon: GitBranch, key: "aiWorkflows",   module: "ai" },
      { href: "/ai-tools/product-descriptions",icon: Bot,       key: "aiProductDesc", module: "ai" },
...
function AppShellInner({ children }: { children: React.ReactNode }) {
  ...
  useEffect(() => {
    ...
    setExpandedSection(saved && !fromPath ? saved : fromPath ?? "dashboard");
