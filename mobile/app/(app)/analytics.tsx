  ...
  return (
    <SafeAreaView style={styles.safe}>
      {isTablet && (
        <TabletTopBar
          title="Analytics"
          subtitle={`Last ${PERIODS.find(p => p.key === period)?.label}`}
          testID="analytics-tablet-topbar"
        />
      )}
      <ScrollView
      ...
      >
        {!isTablet && <Text style={styles.title}>Analytics</Text>}
        ...
        {loading ? (
          ...
          <>
            ...
            {/* Tablet landscape: Top Products + Top Customers side-by-side. */}
            {isTablet && isLandscape ? (
              <View style={styles.twoCol} testID="analytics-two-col">
                <Card title="Top Customers" style={[styles.listCard, { flex: 1 }]}>
